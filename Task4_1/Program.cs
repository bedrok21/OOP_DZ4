namespace Task4_1
{
    ...
    {
        private static bool AddObject(List<GeographicObject> objects, string? type)
        {
            try
            {
                switch (type)
        ...
        private static void InputGeneralInfo(GeographicObject geographicObject)
        {
            double x;
            double y;
        ...
        {
            List<GeographicObject> objects = new List<GeographicObject>();
            bool flag1 = true;
            bool flag2;
            string? comand;
            string? type;
            while (flag1)
            {
                ...
                switch (comand)
                {
                    case "Add":
                        ...
                        break;
                    case "Show":
                        foreach (GeographicObject g_object in objects)
                        {
                            g_object.GetInfo();
                            Console.WriteLine();
                        }
